...
export const CANDIDATES: Candidate[] = [
  ...
  { id: 'm1', number: '01', name: 'မင်းစွမ်းပြည့်', class: '31', categoryId: CategoryId.MISTER, imageUrl: getImg(27), quote: "I'm just Ken... enough.", bio: "Bringing charm and AI expertise." },
  { id: 'm2', number: '02', name: 'ပြည့်စုံထွန်း', class: '32', categoryId: CategoryId.MISTER, imageUrl: getImg(28), quote: "Laughter is the best debugger.", bio: "Class clown." },
  { id: 'm3', number: '03', name: 'ဝေယံဦ်း', class: '33', categoryId: CategoryId.MISTER, imageUrl: getImg(29), quote: "Bringing sexy back to code.", bio: "Musician and coder." },
  { id: 'm4', number: '04', name: 'ပြည့်ဖြိုးဟိန်း', class: '34', categoryId: CategoryId.MISTER, imageUrl: getImg(30), quote: "I see everything.", bio: "Data analyst with vision." },
  { id: 'm5', number: '05', name: 'မျိုးသီဟကျော်', class: '35', categoryId: CategoryId.MISTER, imageUrl: getImg(31), quote: "With great power comes great responsibility.", bio: "Web crawler." },
  { id: 'm6', number: '06', name: 'ဇော်မိုးထွန်း', class: '36', categoryId: CategoryId.MISTER, imageUrl: getImg(32), quote: "I am Iron Man.", bio: "Tech genius billionaire (in making)." },
  { id: 'm7', number: '07', name: 'ဝဿန်', class: '37', categoryId: CategoryId.MISTER, imageUrl: getImg(33), quote: "I can do this all day.", bio: "Class representative." },
  { id: 'm8', number: '08', name: 'အောင်ချမ်းမြေ့ဦး', class: '38', categoryId: CategoryId.MISTER, imageUrl: getImg(34), quote: "I'm Batman.", bio: "Cybersecurity specialist." },
  
  { id: 'm10', number: '09', name: 'ခန့်ဇေယျာကျော်', class: '40', categoryId: CategoryId.MISTER, imageUrl: getImg(36), quote: "Fastest coder alive.", bio: "Track team captain." },

  // --- MISS Candidates (11) ---
  { id: 'ms1', number: '01', name: 'ခိုင်ဆွေရည်', class: '46', categoryId: CategoryId.MISS, imageUrl: getImg(42), quote: "Data tells a story.", bio: "Data Science major." },
  { id: 'ms2', number: '02', name: 'နီလာပြည့်ဖြိုး', class: '47', categoryId: CategoryId.MISS, imageUrl: getImg(43), quote: "Shake it off, code it up.", bio: "Web wizard." },
  { id: 'ms3', number: '03', name: 'မွန်းမွန်း', class: '48', categoryId: CategoryId.MISS, imageUrl: getImg(44), quote: "Thank u, next (bug).", bio: "Vocal about variable naming." },
  { id: 'ms4', number: '04', name: 'စန္ဒီလင််းလက်', class: '49', categoryId: CategoryId.MISS, imageUrl: getImg(45), quote: "Kill 'em with kindness.", bio: "Community manager." },
  { id: 'ms5', number: '05', name: 'နွေးနွေးလှိုင်', class: '50', categoryId: CategoryId.MISS, imageUrl: getImg(46), quote: "Duh.", bio: "Alternative thinker." },
  { id: 'ms6', number: '06', name: 'ဆုမြတ်နိုး', class: '51', categoryId: CategoryId.MISS, imageUrl: getImg(47), quote: "New rules.", bio: "Defining new protocols." },
  { id: 'ms7', number: '07', name: 'အလင်္ကာမိုး', class: '52', categoryId: CategoryId.MISS, imageUrl: getImg(48), quote: "Hear me roar.", bio: "Network administrator." },
  { id: 'ms8', number: '08', name: 'ဖြိုးသီရိ', class: '53', categoryId: CategoryId.MISS, imageUrl: getImg(49), quote: "Shine bright like a diamond.", bio: "UI/UX polished perfection." },
  { id: 'ms9', number: '09', name: 'မို့မို့သဇင်', class: '54', categoryId: CategoryId.MISS, imageUrl: getImg(50), quote: "Run the world (girls).", bio: "Project Manager." },
  { id: 'ms10', number: '10', name: 'ဟန်နီဇင်', class: '55', categoryId: CategoryId.MISS, imageUrl: getImg(51), quote: "Hello, it's me.", bio: "Communication specialist." },
  { id: 'ms11', number: '11', name: 'စံထိပ်ထားခင်', class: '56', categoryId: CategoryId.MISS, imageUrl: getImg(52), quote: "Born this way.", bio: "Advocate for accessibility." },
];
